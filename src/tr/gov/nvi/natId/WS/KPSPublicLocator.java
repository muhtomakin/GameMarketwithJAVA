...
public class KPSPublicLocator extends org.apache.axis.client.Service implements tr.gov.nvi.natId.WS.KPSPublic {
    ...
    public tr.gov.nvi.natId.WS.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public tr.gov.nvi.natId.WS.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            tr.gov.nvi.natId.WS.KPSPublicSoapStub _stub = new tr.gov.nvi.natId.WS.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (tr.gov.nvi.natId.WS.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                tr.gov.nvi.natId.WS.KPSPublicSoapStub _stub = new tr.gov.nvi.natId.WS.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
