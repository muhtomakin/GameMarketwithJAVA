...
public class KPSPublicSoapProxy implements tr.gov.nvi.natId.WS.KPSPublicSoap {
	  private String _endpoint = null;
	  private tr.gov.nvi.natId.WS.KPSPublicSoap kPSPublicSoap = null;
	  ...
	  private void _initKPSPublicSoapProxy() {
	    try {
	      kPSPublicSoap = (new tr.gov.nvi.natId.WS.KPSPublicLocator()).getKPSPublicSoap();
	  ...
	  public tr.gov.nvi.natId.WS.KPSPublicSoap getKPSPublicSoap() {
	    if (kPSPublicSoap == null)
	      _initKPSPublicSoapProxy();
